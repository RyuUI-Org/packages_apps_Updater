...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.ryu.version";
    public static final String PROP_DEVICE = "ro.ryu.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "ryu.updater.allow_downgrading";
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "ryu.updater.allow_major_update";
